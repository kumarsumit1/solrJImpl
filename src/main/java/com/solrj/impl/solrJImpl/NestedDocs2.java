...
public static void main ( String[] args ) throws Exception {
  ...
  */
    ...
    person1.addField( "content_type_t",  "person"     );
    ...
    p1_car1.addField( "content_type_t",  "car"        );
    ...
    p1_car2.addField( "content_type_t",  "car"        );
    ...
    p1_bike1.addField( "content_type_t", "bike"       );
    ...
    p1_bike2.addField( "content_type_t", "bike"       );
    ...
    person2.addField( "content_type_t", "person"       );
    ...
    p2_car1.addField( "content_type_t",  "car"         );
    ...
    p2_bike1.addField( "content_type_t", "bike"        );
    ...
    ***/
    ...
    doQuery(solr,
            ...
            "*:*",
            "{!parent which=\"content_type_t:person\"}"
                + "(content_type_t:car AND make_t:Honda)"
                + " OR (content_type_t:bike AND make_t:Peugeot)");
    ...
    doQuery(solr,
            "All cars owned by Mr. Jones",
            "content_type_t:car",
            "{!child of=\"content_type_t:person\"}last_name_t:jones");
    ...
    params.put( "parent_filter", "content_type_t:person" );
